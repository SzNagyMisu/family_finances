...
module Finances
  RSpec.describe ExpenseCategoriesController, type: :controller do
    ...
    describe "GET #show" do
      it "returns a success response" do
        expense_category = ExpenseCategory.create! valid_attributes
        get :show, params: {id: expense_category.to_param}, session: valid_session
        expect(response).to be_success
      end
    end
    ...
    describe "POST #create" do
      context "with valid params" do
        it "creates a new ExpenseCategory" do
          expect {
            post :create, params: {expense_category: valid_attributes}, session: valid_session
          }.to change(ExpenseCategory, :count).by(1)
        end

        it "redirects to the created expense_category" do
          post :create, params: {expense_category: valid_attributes}, session: valid_session
          expect(response).to redirect_to(ExpenseCategory.last)
        end
      end

      context "with invalid params" do
        it "returns a success response (i.e. to display the 'new' template)" do
          post :create, params: {expense_category: invalid_attributes}, session: valid_session
          expect(response).to be_success
        end
      end
    end
    ...
    describe "PUT #update" do
      context "with valid params" do
        ...
        it "updates the requested expense_category" do
          expense_category = ExpenseCategory.create! valid_attributes
          put :update, params: {id: expense_category.to_param, expense_category: new_attributes}, session: valid_session
        ...
        it "redirects to the expense_category" do
          expense_category = ExpenseCategory.create! valid_attributes
          put :update, params: {id: expense_category.to_param, expense_category: valid_attributes}, session: valid_session
          expect(response).to redirect_to(expense_category)
        end
      end
      ...
      context "with invalid params" do
        it "returns a success response (i.e. to display the 'edit' template)" do
          expense_category = ExpenseCategory.create! valid_attributes
          put :update, params: {id: expense_category.to_param, expense_category: invalid_attributes}, session: valid_session
          expect(response).to be_success
        end
      end
    end
